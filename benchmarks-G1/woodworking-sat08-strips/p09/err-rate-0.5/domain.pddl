...
(:action load-highspeed-saw
	...
	:effect (and
		...
		(not (in-highspeed-saw ?b ?m))(increase (total-cost ) 30)))
...
(:action cut-board-small
	...
	:effect (and
		...
		(not (boardsize-successor ?size_before ?size_before))(increase (total-cost ) 10)))
...
(:action cut-board-large
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (boardsize-successor ?s2 ?size_after))(increase (total-cost ) 10)))
...
(:action do-saw-small
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (boardsize ?b ?size_after))(increase (total-cost ) 30)))
...
(:action do-saw-large
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (boardsize-successor ?s1 ?size_after))(increase (total-cost ) 30))) )