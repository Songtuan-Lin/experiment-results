(define (domain elevators-sequencedstrips)
  ...
  (:action move-up-slow
	...
	:effect (and
		(not (lift-at ?lift ?f1))
		(lift-at ?lift ?f2)(increase (total-cost ) (travel-slow ?f1 ?f2))))
  ...
  (:action move-down-slow
	...
	:effect (and
		(not (lift-at ?lift ?f1))
		(lift-at ?lift ?f2)(increase (total-cost ) (travel-slow ?f2 ?f1))))
  ...
  (:action move-up-fast
	...
	:effect (and
		(lift-at ?lift ?f2)
		(not (lift-at ?lift ?f1))(increase (total-cost ) (travel-fast ?f1 ?f2))))
  ...
  (:action move-down-fast
	...
	:effect (and
		(not (lift-at ?lift ?f1))
		(lift-at ?lift ?f2)(increase (total-cost ) (travel-fast ?f2 ?f1))))
