(define (domain agricola)
  ...
  (:action ag__harvest_collecting_veg
	...
	:effect (and
		...
		(not (sown_veg ?v))
		(not (can_harvest ?v))
		(num_substract ?i3 ?i3 ?i1)(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_feed
	...
	:effect (and
		...
		(can_breed boar)
		(can_breed cattle)
		(num_substract ?inow ?inow ?ifeed)(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_breeding_animal
	...
	:effect (and
		(not (num_food ?i))
		(not (can_breed ?a))
		(num_food ?i2)(increase (total-cost ) 1)))
  ...
  (:action plow_field
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(next_worker ?w1 ?w1)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action take_grain
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(not (next_round ?r ?r))(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action collect_animal
	...
	:effect (and
		...
		(current_worker ?w2)
		(owned_animals ?a)
		(not (newborn ))(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action collect_resource
	...
	:effect (and
		...
		(current_worker ?w2)
		(stored_resource ?res)
		(next_worker ?wmax ?w2)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action improve_home
	...
	:effect (and
		...
		(next_worker ?w1 ?w2)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action family_growth
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(newborn )(increase (total-cost ) (group_worker_cost ?wmax))))
