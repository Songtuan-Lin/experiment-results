(define (domain agricola)
  ...
  (:action ag__harvest_collect_end
	...
	:effect (and
		...
		(next_stage ?s ?s)(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_breed_end
	...
	:precondition (and
		...
		(category_round ?r tharvest))
	:effect (and
		(not (harvest_phase ?s harvest_breeding))(increase (total-cost ) 1)))
  ...
  (:action ag__finish_round_renew
	...
	:effect (and
		...
		(can_harvest grain)
		(can_harvest carrot)
		(not (newborn ))(increase (total-cost ) 1)))
  ...
  (:action take_food
	...
	:effect (and
		...
		(not (num_food ?i1))
		(num_food ?i2)
		(next_worker ?wmax ?w1)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action build_fences
	...
	:effect (and
		...
		(current_worker ?w2)
		(fences_for ?a)
		(next_worker ?w2 ?wmax)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action family_growth
	...
	:effect (and
		...
		(current_worker ?w2)
		(newborn )
		(next_worker ?w2 ?wnewmax)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action sow
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(max_worker ?wmax)(increase (total-cost ) (group_worker_cost ?wmax)))))