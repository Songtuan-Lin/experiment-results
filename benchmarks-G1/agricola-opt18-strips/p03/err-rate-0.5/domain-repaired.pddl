(define (domain agricola)
  ...
  (:action ag__harvest_breeding_animal
	...
	:effect (and
		...
		(num_food ?i2)
		(not (can_breed ?a))
		(next2_num ?i ?i)(increase (total-cost ) 1)))
  ...
  (:action ag__advance_round_normal
	...
	:effect (and
		...
		(open_action ?act)
		(next_round ?r1 ?r2)
		(open_action act_cattle)(increase (total-cost ) 1)))
  ...
  (:action ag__finish_stage
	...
	:effect (and
		...
		(current_round ?r2)
		(current_stage ?s2)
		(harvest_phase ?s2 harvest_init)(increase (total-cost ) 1)))
  ...
  (:action build_room
	...
	:effect (and
		...
		(next_worker ?w2 ?w1)(increase (total-cost ) (group_worker_cost ?wmax))))
