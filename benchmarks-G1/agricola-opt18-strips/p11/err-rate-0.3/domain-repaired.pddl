(define (domain agricola)
  ...
  (:action ag__harvest_collecting_veg
	...
	:effect (and
		(not (num_food ?i1))
		(num_food ?i3)
		(not (sown_veg ?v))(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_collecting_fromoven
	...
	:effect (and
		...
		(not (sown_veg ?v))
		(not (can_harvest ?v))
		(not (num_substract ?i3 ?i1 ?i2))(increase (total-cost ) 1)))
  ...
  (:action ag__advance_round_normal
	...
	:effect (and
		...
		(current_round ?r2)
		(open_action ?act)
		(not (drawcard_round ?act ?r1))(increase (total-cost ) 1)))
  ...
  (:action take_grain
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(sown_veg ?v)(increase (total-cost ) (group_worker_cost ?wmax))))
