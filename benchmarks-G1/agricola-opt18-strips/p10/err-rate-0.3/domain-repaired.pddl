(define (domain agricola)
  ...
  (:action ag__harvest_collecting_fromoven
	...
	:effect (and
		...
		(not (sown_veg ?v))
		(not (can_harvest ?v))
		(num_substract ?i1 ?i2 ?i2)(increase (total-cost ) 1)))
  ...
  (:action plow_field
	...
	:effect (and
		...
		(current_worker ?w2)
		(not (current_round ?r))
		(current_round ?r)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action build_fences
	...
	:effect (and
		...
		(current_worker ?w2)
		(fences_for ?a)
		(can_breed ?a)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action build_room
	...
	:effect (and
		...
		(not (next_worker ?wmax ?wnewmax))(increase (total-cost ) (group_worker_cost ?wmax))))
