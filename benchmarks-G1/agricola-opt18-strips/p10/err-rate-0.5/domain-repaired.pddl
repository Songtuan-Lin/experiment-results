(define (domain agricola)
  ...
  (:action ag__advance_round_normal
	...
	:effect (and
		...
		(current_round ?r2)
		(open_action ?act)
		(not (next_round ?r2 ?r1))(increase (total-cost ) 1)))
  ...
  (:action take_food
	...
	:effect (and
		...
		(not (num_food ?i1))
		(num_food ?i2)
		(next_num ?i1 ?i1)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action collect_animal
	...
	:effect (and
		...
		(current_worker ?w2)
		(owned_animals ?a)
		(next_round ?r ?r)(increase (total-cost ) (group_worker_cost ?wmax))))
