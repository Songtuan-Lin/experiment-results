(define (domain agricola)
  ...
  (:action ag__harvest_collecting_fromoven
	...
	:effect (and
		...
		(not (sown_veg ?v))
		(not (can_harvest ?v))
		(not (num_substract ?i2 ?i2 ?i3))(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_breeding_animal
	...
	:effect (and
		...
		(num_food ?i2)
		(not (can_breed ?a))
		(num_substract ?i ?i ?i2)(increase (total-cost ) 1)))
  ...
  (:action ag__finish_round_renew
	...
	:effect (and
		...
		(can_harvest grain)
		(can_harvest carrot)
		(next_worker ?maxw ?maxw)(increase (total-cost ) 1)))
  ...
  (:action collect_cook_animal
	...
	:effect (and
		...
		(num_food ?i2)
		(ok )
		(not (next2_num ?i1 ?i1))(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action sow
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(not (next_worker ?w1 ?w1))(increase (total-cost ) (group_worker_cost ?wmax)))))