(define (domain woodworking)
  ...
  (:action do-immersion-varnish
	...
	:effect (and
		...
		(colour ?x ?newcolour)
		(not (unused ?x))(increase (total-cost ) 10)))
...
(:action do-grind
	...
	:effect (and
		...
		(colour ?x natural)
		(not (grind-treatment-change ?newtreatment ?newtreatment))(increase (total-cost ) (grind-cost ?x))))
...
(:action cut-board-small
	...
	:effect (and
		...
		(not (boardsize ?b ?size_after))(increase (total-cost ) 10)))
...
(:action do-saw-medium
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (boardsize ?b ?s1))(increase (total-cost ) 30)))
