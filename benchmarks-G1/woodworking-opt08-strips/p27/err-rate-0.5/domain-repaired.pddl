(define (domain woodworking)
  ...
  (:action do-immersion-varnish
	...
	:effect (and
		...
		(colour ?x ?newcolour)
		(treatment ?x varnished)(increase (total-cost ) 10)))
  ...
  (:action do-glaze
	...
	:effect (and
		...
		(not (colour ?x natural))
		(colour ?x ?newcolour)
		(treatment ?x glazed)(increase (total-cost ) (glaze-cost ?x))))
  ...
  (:action do-plane
	...
	:effect (and
		...
		(not (treatment ?x ?oldtreatment))
		(treatment ?x untreated)
		(not (colour ?x ?oldcolour))(increase (total-cost ) (plane-cost ?x))))
  ...
  (:action cut-board-small
	...
	:effect (and
		...
		(colour ?p natural)
		(treatment ?p untreated)(increase (total-cost ) 10)))
  ...
  (:action do-saw-medium
	...
	:effect (and
		...
		(colour ?p natural)(increase (total-cost ) 30)))
