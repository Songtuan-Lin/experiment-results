(define (domain woodworking)
  ...
  (:action cut-board-medium
	...
	:precondition (and
		...
		(boardsize-successor ?s1 ?size_after))
	:effect (and
		(not (unused ?p))
		(available ?p)
		(wood ?p ?w)
  ...
  (:action cut-board-large
	...
	:precondition (and
		...
		(boardsize-successor ?size_before ?s2))
	:effect (and
		(not (unused ?p))
		(available ?p)
		(wood ?p ?w)
  ...
  (:action do-saw-medium
	...
	:precondition (and
		...
		(boardsize-successor ?size_after ?s1)
		(boardsize-successor ?s1 ?size_before)
		(boardsize-successor ?size_before ?s1))
	:effect (and
		(not (unused ?p))
		(available ?p)
		(wood ?p ?w)
  ...
  (:action do-saw-large
	...
	:effect (and
		...
		(boardsize-successor ?size_before ?s2)(increase (total-cost ) 30))))