...
(:action do-grind
	...
	:effect (and
		...
		(colour ?x natural)
		(not (grind-treatment-change ?oldtreatment ?oldtreatment))(increase (total-cost ) (grind-cost ?x))))
...
(:action cut-board-medium
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (boardsize-successor ?s1 ?size_before))(increase (total-cost ) 10)))
...
(:action do-saw-medium
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (boardsize-successor ?size_after ?size_after))(increase (total-cost ) 30)))
