...
(:action tal-to-col
	...
	:effect (and
		...
		(not (canstack ?cardabove ?newcard))))
...
(:action tal-to-home-b
	...
	:effect (and
		...
		(not (ontalon ?cardabove ?card))
		(not (home ?homecard))
		(not (canstack ?homecard ?homecard))))
