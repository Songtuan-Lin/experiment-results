(define (domain tetris)
  ...
  (:action move_l_right
	...
	:effect (and
		...
		(not (at_right_l ?element ?xy_initial2 ?xy_between_final ?xy_initial1))(increase (total-cost ) 3)))
  ...
  (:action move_l_left
	...
	:effect (and
		...
		(not (clear ?xy_final2))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial2 ?xy_initial3))
		(connected ?xy_initial1 ?xy_initial3)(increase (total-cost ) 3)))
  ...
  (:action move_l_up
	...
	:effect (and
		...
		(not (clear ?xy_final2))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial2 ?xy_initial3))
		(at_right_l ?element ?xy_final2 ?xy_initial3 ?xy_final)(increase (total-cost ) 3)))
