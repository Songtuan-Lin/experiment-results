(define (domain tetris)
  ...
  (:action move_square
	...
	:effect (and
		...
		(not (clear ?xy_final))(increase (total-cost ) 1)))
...
(:action move_two
	...
	:effect (and
		...
		(connected ?xy_initial2 ?xy_final)(increase (total-cost ) 2)))
...
(:action move_l_down
	...
	:effect (and
		...
		(at_right_l ?element ?xy_initial3 ?xy_final ?xy_initial3)(increase (total-cost ) 3))) )