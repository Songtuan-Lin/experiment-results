(define (domain tetris)
  ...
  (:action move_square
	...
	:effect (and
		...
		(connected ?xy_initial ?xy_initial)(increase (total-cost ) 1)))
...
(:action move_two
	...
	:effect (and
		...
		(not (connected ?xy_initial1 ?xy_final))(increase (total-cost ) 2)))
...
(:action move_l_up
	...
	:effect (and
		...
		(not (at_right_l ?element ?xy_between_final ?xy_initial1 ?xy_initial1))(increase (total-cost ) 3)))
