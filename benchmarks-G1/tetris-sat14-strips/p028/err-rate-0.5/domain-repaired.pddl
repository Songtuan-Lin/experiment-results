(define (domain tetris)
  ...
  (:action move_square
	...
	:effect (and
		...
		(clear ?xy_initial)(increase (total-cost ) 1)))
  ...
  (:action move_l_right
	...
	:effect (and
		...
		(at_right_l ?element ?xy_initial2 ?xy_between_final ?xy_initial3)(increase (total-cost ) 3)))
  ...
  (:action move_l_down
	...
	:effect (and
		...
		(not (clear ?xy_final2))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial2 ?xy_initial3))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial3 ?xy_final2))(increase (total-cost ) 3))))