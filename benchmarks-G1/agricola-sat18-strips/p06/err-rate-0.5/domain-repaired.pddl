(define (domain agricola)
  ...
  (:action ag__harvest_feed
	...
	:effect (and
		...
		(can_breed boar)
		(can_breed cattle)
		(num_substract ?ifeed ?inow ?inow)(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_breed_end
	...
	:effect (and
		...
		(not (current_round ?r))(increase (total-cost ) 1)))
  ...
  (:action ag__advance_round_normal
	...
	:effect (and
		...
		(current_round ?r2)
		(open_action ?act)
		(not (current_round ?r1))(increase (total-cost ) 1)))
  ...
  (:action build_room
	...
	:effect (and
		...
		(built_rooms ?room ?w1)(increase (total-cost ) (group_worker_cost ?wmax))))
