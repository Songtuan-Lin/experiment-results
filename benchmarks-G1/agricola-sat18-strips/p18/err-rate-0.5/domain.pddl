...
(:action ag__finish_round_backhome
	...
	:effect (and
		...
		(not (next_round ?r ?r))(increase (total-cost ) 1)))
...
(:action take_food
	...
	:effect (and
		...
		(not (num_food ?i1))
		(num_food ?i2)
		(num_substract ?i2 ?i2 ?i1)(increase (total-cost ) (group_worker_cost ?wmax))))
...
(:action take_grain
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(not (current_round ?r))(increase (total-cost ) (group_worker_cost ?wmax))))
