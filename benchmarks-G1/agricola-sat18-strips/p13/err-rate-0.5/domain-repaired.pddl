(define (domain agricola)
  ...
  (:action ag__harvest_collecting_veg
	...
	:effect (and
		...
		(not (sown_veg ?v))
		(not (can_harvest ?v))
		(num_substract ?i1 ?i3 ?i3)(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_collecting_fromoven
	...
	:effect (and
		...
		(not (sown_veg ?v))
		(not (can_harvest ?v))
		(num_substract ?i3 ?i3 ?i2)(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_feed
	...
	:effect (and
		...
		(can_breed boar)
		(can_breed cattle)
		(food_required ?wmax ?irest)(increase (total-cost ) 1)))
  ...
  (:action sow
	...
	:effect (and
		...
		(not (current_worker ?w1))
		(current_worker ?w2)
		(not (next_worker ?w1 ?wmax))(increase (total-cost ) (group_worker_cost ?wmax)))))