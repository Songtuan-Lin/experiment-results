(define (domain agricola)
  ...
  (:action ag__harvest_collecting_fromoven
	...
	:effect (and
		...
		(not (sown_veg ?v))
		(not (can_harvest ?v))
		(next_num ?i1 ?i1)(increase (total-cost ) 1)))
  ...
  (:action ag__harvest_feed
	...
	:effect (and
		...
		(can_breed boar)
		(can_breed cattle)
		(next2_num ?inow ?inow)(increase (total-cost ) 1)))
  ...
  (:action collect_cook_animal
	...
	:effect (and
		...
		(num_food ?i2)
		(ok )
		(food_required ?wmax ?i1)(increase (total-cost ) (group_worker_cost ?wmax))))
  ...
  (:action improve_home
	...
	:effect (and
		...
		(not (current_worker ?wmax))(increase (total-cost ) (group_worker_cost ?wmax))))
