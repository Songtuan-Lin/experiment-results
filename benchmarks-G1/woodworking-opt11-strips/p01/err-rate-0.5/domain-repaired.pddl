(define (domain woodworking)
  ...
  (:action do-immersion-varnish
	...
	:effect (and
		...
		(not (colour ?x natural))(increase (total-cost ) 10)))
  ...
  (:action do-spray-varnish
	...
	:effect (and
		(not (treatment ?x untreated))
		(treatment ?x varnished)
		(not (colour ?x natural))(increase (total-cost ) (spray-varnish-cost ?x))))
  ...
  (:action do-grind
	...
	:effect (and
		...
		(not (colour ?x ?oldcolour))(increase (total-cost ) (grind-cost ?x))))
  ...
  (:action do-plane
	...
	:effect (and
		...
		(colour ?x natural)
		(surface-condition ?x smooth)(increase (total-cost ) (plane-cost ?x))))
  ...
  (:action load-highspeed-saw
	...
	:effect (and
		(not (available ?b))
		(not (empty ?m))(increase (total-cost ) 30)))
  ...
  (:action do-saw-large
	...
	:effect (and
		...
		(wood ?p ?w)(increase (total-cost ) 30))))