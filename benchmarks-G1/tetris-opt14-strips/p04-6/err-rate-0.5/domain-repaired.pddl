(define (domain tetris)
  ...
  (:action move_square
	...
	:effect (and
		...
		(connected ?xy_final ?xy_initial)(increase (total-cost ) 1)))
  ...
  (:action move_two
	...
	:effect (and
		...
		(at_two ?element ?xy_initial2 ?xy_final)(increase (total-cost ) 2)))
  ...
  (:action move_l_down
	...
	:effect (and
		...
		(at_right_l ?element ?xy_final ?xy_final2 ?xy_initial2)(increase (total-cost ) 3))))