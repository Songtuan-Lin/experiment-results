(define (domain tetris)
  ...
  (:action move_two
	...
	:effect (and
		...
		(not (clear ?xy_final))
		(at_two ?element ?xy_initial1 ?xy_initial2)(increase (total-cost ) 2)))
  ...
  (:action move_l_up
	...
	:effect (and
		...
		(at_right_l ?element ?xy_initial1 ?xy_final ?xy_initial2)(increase (total-cost ) 3)))
  ...
  (:action move_l_down
	...
	:effect (and
		...
		(not (clear ?xy_final2))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial2 ?xy_initial3))
		(at_right_l ?element ?xy_initial3 ?xy_initial3 ?xy_final2)(increase (total-cost ) 3))))