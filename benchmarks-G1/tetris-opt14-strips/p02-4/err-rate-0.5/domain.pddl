...
(:action move_l_right
	...
	:effect (and
		...
		(not (at_right_l ?element ?xy_between_final ?xy_final ?xy_initial3))(increase (total-cost ) 3)))
...
(:action move_l_up
	...
	:effect (and
		...
		(not (clear ?xy_final2))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial2 ?xy_initial3))
		(at_right_l ?element ?xy_initial3 ?xy_final2 ?xy_final)(increase (total-cost ) 3)))
...
(:action move_l_down
	...
	:precondition (and
		...
		(connected ?xy_final2 ?xy_final)
		(not (= ?xy_final ?xy_final2))
		(at_right_l ?element ?xy_initial1 ?xy_initial1 ?xy_final))
	:effect (and
		(clear ?xy_initial3)
		(clear ?xy_initial1)
