(define (domain tetris)
  ...
  (:action move_square
	...
	:effect (and
		...
		(not (at_square ?element ?xy_final))(increase (total-cost ) 1)))
...
(:action move_l_right
	...
	:effect (and
		...
		(at_right_l ?element ?xy_final2 ?xy_initial1 ?xy_final2)(increase (total-cost ) 3)))
...
(:action move_l_left
	...
	:effect (and
		...
		(not (clear ?xy_final2))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial2 ?xy_initial3))
		(at_right_l ?element ?xy_initial2 ?xy_initial1 ?xy_final2)(increase (total-cost ) 3)))
