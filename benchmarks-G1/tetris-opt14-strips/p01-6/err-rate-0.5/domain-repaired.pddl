(define (domain tetris)
  ...
  (:action move_two
	...
	:effect (and
		...
		(not (at_two ?element ?xy_final ?xy_final))(increase (total-cost ) 2)))
  ...
  (:action move_l_up
	...
	:effect (and
		...
		(not (at_right_l ?element ?xy_initial1 ?xy_final2 ?xy_final))(increase (total-cost ) 3)))
  ...
  (:action move_l_down
	...
	:effect (and
		...
		(not (clear ?xy_final2))
		(not (at_right_l ?element ?xy_initial1 ?xy_initial2 ?xy_initial3))
		(not (at_right_l ?element ?xy_final2 ?xy_initial1 ?xy_initial1))(increase (total-cost ) 3))))