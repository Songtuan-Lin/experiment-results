...
(:action do-grind
	...
	:effect (and
		...
		(colour ?x natural)
		(not (treatment ?x ?newtreatment))(increase (total-cost ) (grind-cost ?x))))
...
(:action cut-board-small
	...
	:effect (and
		...
		(not (is-smooth ?surface))(increase (total-cost ) 10)))
...
(:action cut-board-large
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (boardsize-successor ?size_after ?size_before))(increase (total-cost ) 10)))
...
(:action do-saw-medium
	...
	:effect (and
		...
		(treatment ?p untreated)
		(boardsize ?b ?size_after)
		(not (is-smooth ?surface))(increase (total-cost ) 30)))
