(define (domain data-network)
  ...
  (:action save
	...
	:effect (and
		(saved ?d ?s)
		(connected ?s ?s)(increase (total-cost ) (io-cost ?s ?size))))
  ...
  (:action send
	...
	:effect (and
		...
		(not (usage ?to ?before))
		(usage ?to ?after)
		(sum ?after ?size ?limit)(increase (total-cost ) (send-cost ?from ?to ?size))))
  ...
  (:action process
	...
	:effect (and
		...
		(not (usage ?s ?before))
		(usage ?s ?after)
		(less-equal ?limit ?before)(increase (total-cost ) (process-cost ?sc ?s)))))